# Graph Report - myNixOS  (2026-06-25)
...
## Summary
- 114 nodes · 105 edges · 12 communities (10 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e6b63706`
...
8. `Recommended Boundaries` - 4 edges
9. `Phase 5: Add Home Manager` - 4 edges
10. `agent` - 3 edges
...
Cohesion: 0.29
Nodes (6): Build, Current Status, myNixOS, Related Docs, Repository Layout, Workflow Notes
...
## Knowledge Gaps
- **87 isolated node(s):** `$schema`, `plugin`, `@opencode-ai/plugin`, `$schema`, `model` (+82 more)
